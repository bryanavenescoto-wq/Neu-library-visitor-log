...
onAuthStateChanged(auth, async (user) => {
  ...
  // ✅ ONLY ALLOW NEU EMAILS
  if (!user.email.endsWith("@neu.edu.ph")) {
    alert("Use your NEU email only!");
    window.location.href = "index.html";
    return;
  }
 ...
 const ADMIN_LIST = [
  "admin@neu.edu.ph",
  "bryanaven.escoto@neu.edu.ph",
  "jcesperanza@neu.edu.ph"
].map(e => e.toLowerCase());

let isAdmin = ADMIN_LIST.includes(user.email.toLowerCase());
